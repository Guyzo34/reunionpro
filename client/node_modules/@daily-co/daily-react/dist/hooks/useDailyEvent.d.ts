...
declare type EventCallback<T extends DailyEvent> = (event: DailyEventObject<T>) => void;
 ...
 */
export declare const useDailyEvent: <T extends DailyEvent>(ev: T, callback: EventCallback<T>) => void;
export {};
