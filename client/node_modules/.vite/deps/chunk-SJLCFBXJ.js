...
function o(e2) {
  var t2 = function(e3, t3) {
    if ("object" !== i(e3) || null === e3) return e3;
...
var $ = /version\/(\d+(\.?_?\d+)+)/i;
var G = [{ test: [/googlebot/i], describe(e2) {
...
var q = [{ test: [/Roku\/DVP/], describe(e2) {
...
var Y = [{ test: [/googlebot/i], describe: () => ({ type: "bot", vendor: "Google" }) }, { test: [/huawei/i], describe(e2) {
...
var J = [{ test: (e2) => "microsoft edge" === e2.getBrowserName(true), describe(e2) {
...
function Tt(e2) {
  ...
  return { $: t2, add: function(r2) {
    if (!(void 0 === e2 || t2.length < e2)) return Et(new Ne("Not adding Promise because buffer limit was reached."));
    const i2 = r2();
...
var Pt = we();
var xt = { nowSeconds: () => Date.now() / 1e3 };
var At = "undefined" != typeof __SENTRY_BROWSER_BUNDLE__ && __SENTRY_BROWSER_BUNDLE__ || "[object process]" !== Object.prototype.toString.call("undefined" != typeof process ? process : 0) ? function() {
...
var jt = void 0 === At ? xt : { nowSeconds: () => (At.timeOrigin + At.now()) / 1e3 };
var Lt = xt.nowSeconds.bind(xt);
var Dt = jt.nowSeconds.bind(jt);
function Nt(e2, t2 = []) {
  return [e2, t2];
}
function It(e2, t2) {
...
var mn = class _mn {
  ...
  captureException(e2, t2, n2) {
    if (yt(e2)) return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.log(gn));
  ...
  captureEvent(e2, t2, n2) {
    if (t2 && t2.originalException && yt(t2.originalException)) return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.log(gn));
    let r2 = t2 && t2.event_id;
  ...
  sendEvent(e2, t2 = {}) {
    if (this._dsn) {
      ...
      for (const e3 of t2.attachments || []) n2 = It(n2, Ut(e3, this._options.transportOptions && this._options.transportOptions.textEncoder));
  ...
  _processEvent(e2, t2, n2) {
    ...
    if (a2 && "number" == typeof i2 && Math.random() > i2) return this.recordDroppedEvent("sample_rate", "error", e2), Et(new Ne(`Discarding event because it's not included in the random sample (sampling rate = ${i2})`, "log"));
    const l2 = "replay_event" === s2 ? "replay" : s2;
    return this._prepareEvent(e2, t2, n2).then((n3) => {
      if (null === n3) throw this.recordDroppedEvent("event_processor", l2, e2), new Ne("An event processor returned `null`, will not send event.", "log");
      ...
      return function(e3, t3) {
        ...
        if (le(e3)) return e3.then((e4) => {
          if (!se(e4) && null !== e4) throw new Ne(n4);
          return e4;
        }, (e4) => {
          throw new Ne(`${t3} rejected with ${e4}`);
        });
        if (!se(e3) && null !== e3) throw new Ne(n4);
        return e3;
      }(i3, c2);
    }).then((r3) => {
      if (null === r3) throw this.recordDroppedEvent("before_send", l2, e2), new Ne(`${c2} returned \`null\`, will not send event.`, "log");
...
function bn(e2, t2, n2 = Tt(e2.bufferSize || _n)) {
  ...
  function i2(i3) {
    ...
    return n2.add(() => t2({ body: Ft(a2, e2.textEncoder) }).then((e3) => (void 0 !== e3.statusCode && (e3.statusCode < 200 || e3.statusCode >= 300) && ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn(`Sentry responded with status code ${e3.statusCode} to sent event.`), r2 = Yt(r2, e3), e3), (e3) => {
      ...
      if (e3 instanceof Ne) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.error("Skipped sending event because buffer is full."), s2("queue_overflow"), kt();
      throw e3;
    });
  }
...
En.__initStatic();
var Mn = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/];
var Tn = [/^.*healthcheck.*$/, /^.*healthy.*$/, /^.*live.*$/, /^.*ready.*$/, /^.*heartbeat.*$/, /^.*\/health$/, /^.*\/healthz$/];
var Cn = class _Cn {
  static __initStatic() {
        ...
        if (t3) {
          ...
          return function(e4, t4) {
            if (t4.ignoreInternal && function(e5) {
              ...
              return false;
            }(e4)) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn(`Event dropped due to being internal Sentry Error.
Event: ${gt(e4)}`), true;
            if (function(e5, t5) {
            ...
            }(e4, t4.ignoreErrors)) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${gt(e4)}`), true;
            if (function(e5, t5) {
              if ("transaction" !== e5.type || !t5 || !t5.length) return false;
              const n4 = e5.transaction;
              return !!n4 && fe(n4, t5);
            }(e4, t4.ignoreTransactions)) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${gt(e4)}`), true;
            if (function(e5, t5) {
              if (!t5 || !t5.length) return false;
              const n4 = On(e5);
              return !!n4 && fe(n4, t5);
            }(e4, t4.denyUrls)) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${gt(e4)}.
Url: ${On(e4)}`), true;
            if (!function(e5, t5) {
              ...
              const n4 = On(e5);
              return !n4 || fe(n4, t5);
            }(e4, t4.allowUrls)) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${gt(e4)}.
Url: ${On(e4)}`), true;
            return false;
          }(e3, o2) ? null : e3;
...
Cn.__initStatic();
var Pn = Object.freeze({ __proto__: null, FunctionToString: En, InboundFilters: Cn });
var xn = be;
var An = 0;
function jn() {
  return An > 0;
...
var Hn = class extends mn {
  ...
  _flushOutcomes() {
    ...
    if (0 === e2.length) return void (("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.log("No outcomes to send"));
  ...
  setupOnce() {
    Kt((e2) => {
      if (on().getIntegration(_dr)) {
        if (!xn.navigator && !xn.location && !xn.document) return e2;
      ...
      if (n3) {
        try {
          if (function(e4, t3) {
            ...
            return false;
          }(e3, n3._previousEvent)) return ("undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && xe.warn("Event dropped due to being a duplicate of previously captured event."), null;
        } catch (t3) {
...
hr.__initStatic();
var vr = Object.freeze({ __proto__: null, Breadcrumbs: qn, Dedupe: hr, GlobalHandlers: Xn, HttpContext: dr, LinkedErrors: ur, TryCatch: or });
var yr = {};
...
var pi = "left-meeting";
var fi = "available-devices-updated";
var gi = "participant-joined";
var mi = "participant-updated";
var vi = "participant-left";
var yi = "participant-counts-updated";
var _i = "access-state-updated";
var bi = "meeting-session-summary-updated";
var wi = "meeting-session-state-updated";
var Si = "meeting-session-data-error";
var ki = "waiting-participant-added";
var Ei = "waiting-participant-updated";
var Mi = "waiting-participant-removed";
var Ti = "track-started";
var Ci = "track-stopped";
var Oi = "transcription-started";
var Pi = "transcription-stopped";
var xi = "transcription-error";
var Ai = "recording-started";
var ji = "recording-stopped";
var Li = "recording-stats";
var Di = "recording-error";
var Ni = "recording-upload-completed";
var Ii = "recording-data";
var Ri = "app-message";
var Bi = "transcription-message";
var Fi = "remote-media-player-started";
var Ui = "remote-media-player-updated";
var Vi = "remote-media-player-stopped";
var $i = "local-screen-share-started";
var Gi = "local-screen-share-stopped";
var qi = "local-screen-share-canceled";
var Yi = "active-speaker-change";
var Ji = "active-speaker-mode-change";
var Wi = "network-quality-change";
var zi = "network-connection";
var Hi = "cpu-load-change";
var Qi = "fullscreen";
...
var ao = "error";
var so = 102400;
var co = "iframe-call-message";
var lo = "local-screen-start";
var uo = "register-input-handler";
var ho = "daily-method-update-live-streaming-endpoints";
var po = "transmit-log";
var fo = "daily-custom-track";
var go = { NONE: "none", BGBLUR: "background-blur", BGIMAGE: "background-image" };
var mo = { NONE: "none", NOISE_CANCELLATION: "noise-cancellation" };
var vo = { PLAY: "play", PAUSE: "pause" };
var yo = 10;
var _o = ["jpg", "png", "jpeg"];
...
function Oo() {
  ...
  return !ko() && (e2 ? function() {
    ...
    if (Eo() && "Safari" === e3) {
      var t2 = Ro();
      if (15 === t2.major && t2.minor < 4) return false;
    }
...
var Ho = function() {
  ...
  return s(e2, [{ key: "isNoOp", value: function() {
    ...
    if (!zo.includes(e3)) throw Error("Unrecognized mergeStrategy provided. Options are: [".concat(zo, "]"));
  } }, { key: "_validateData", value: function(e3, t2) {
    if (!function(e4) {
      if (null == e4 || "object" !== i(e4)) return false;
...
var Zo = function() {
  ...
  return s(e2, [{ key: "load", value: function(e3, t2, n2, r2) {
    if (this.loaded) return window._dailyCallObjectSetup(e3), void n2(true);
    !function(e4, t3) {
...
var ia = function() {
  ...
  return s(e2, [{ key: "start", value: (a2 = n(function* () {
    ...
    try {
      ...
      if (clearTimeout(this._networkTimeout), t4 instanceof ta || this.cancelled || this._networkTimedOut) return;
    ...
    if (this._iosCache && 304 === t3.status) return (yield this._iosCache.renew(e3, t3.headers)).code;
...
function pa(e2) {
  try {
    ...
    for (var n2 in e2.tracks) if (!fa(n2)) {
...
function ga(e2, t2) {
  ...
  if (e2.local) {
    ...
    if (!r2) return e2.audio = false, e2.audioTrack = false, e2.video = false, e2.videoTrack = false, e2.screen = false, void (e2.screenTrack = false);
    try {
      n2.streams;
...
function ma(e2, t2) {
  ...
  if (!n2) {
    if (Array.isArray(e2) || (n2 = function(e3, t3) {
      ...
      if ("Arguments" === n3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3)) return va(e3, t3);
...
var Fa = "video";
var Ua = "voice";
var Va = ko() ? { data: {} } : { data: {}, topology: "none" };
var $a = { present: 0, hidden: 0 };
var Ga = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } };
var qa = Object.keys(Ga);
var Ya = ["state", "volume", "simulcastEncodings"];
...
var Wa = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string" } };
var za = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } };
var Ha = { customIntegrations: { validate: ms, help: fs() }, customTrayButtons: { validate: gs, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(Wa)) }, url: { validate: function(e2) {
...
var Qa = { styles: { validate: function(e2) {
...
var Ka = function(t2) {
  ...
  return s(te2, [{ key: "destroy", value: (Z2 = n(function* () {
    ...
    for (var n2 in t3) {
      if (!Qa[n2]) throw new Error("unrecognized updateParticipant property ".concat(n2));
      if (Qa[n2].validate && !Qa[n2].validate(t3[n2], this, this._participants[e2])) throw new Error(Qa[n2].help);
    }
    ...
    for (var n2 in e2) n2 === t3 && (n2 = "local"), n2 && e2[n2] && this.validateParticipantProperties(n2, e2[n2]);
    ...
    if (is(this._callObjectMode, "updateWaitingParticipant()"), Za(this._callState, "updateWaitingParticipant()"), "string" != typeof t3 || "object" !== i(n2)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
    ...
    if (is(this._callObjectMode, "updateWaitingParticipants()"), Za(this._callState, "updateWaitingParticipants()"), "object" !== i(t3)) throw new Error("updateWaitingParticipants() must take a mapping between ids and update objects");
    return new Promise(function(n2, r2) {
    ...
    var t3 = this;
    if (is(this._callObjectMode, "updateReceiveSettings()"), !ls(e2, { allowAllParticipantsKey: true })) throw new Error(ps({ allowAllParticipantsKey: true }));
    ...
    if (as(), this._dailyMainExecuted) return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: t3, trackConstraints: n2 }), this;
  } }, { key: "getDailyLang", value: function() {
    var e2 = this;
    if (as(), this._dailyMainExecuted) return new Promise(function(t3) {
    ...
    if (this.properties.userData = e2, this._dailyMainExecuted) return new Promise(function(n2) {
      try {
    ...
    var t3 = this;
    if (as(), this.validateAudioLevelInterval(e2), this._dailyMainExecuted) return new Promise(function(n2, r2) {
    ...
    if (ss(), [Fa, Ua].includes(e2)) {
      if (e2 !== this._nativeInCallAudioMode) return this._nativeInCallAudioMode = e2, !this.disableReactNativeAutoDeviceManagement("audio") && es(this._callState, this._isPreparingToJoin) && this.nativeUtils().setAudioMode(this._nativeInCallAudioMode), this;
    } else console.error("invalid in-call audio mode specified: ", e2);
  } }, { key: "preAuth", value: (j2 = n(function* () {
    var e2 = this, t3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    if (is(this._callObjectMode, "preAuth()"), ts(this._callState, this._isPreparingToJoin, "preAuth()"), rs(this._testCallInProgress, "preAuth()"), this.needsLoad() && (yield this.load(t3)), !t3.url) throw new Error("preAuth() requires at least a url to be provided");
    ...
    if (this.needsLoad()) {
      ...
      return this._callObjectMode ? new Promise(function(e3, n2) {
        ...
        t3._loadedCallback = function(r2) {
          if (t3._callState !== Tr) {
            for (var i2 in t3._updateCallState(Sr), (t3.properties.cssFile || t3.properties.cssText) && t3.loadCss(t3.properties), t3._inputEventsOn) t3.sendMessageToCallMachine({ action: uo, on: i2 });
            e3();
          } else n2(r2);
        };
      }));
    ...
    return this._preloadCache.inputSettings || (this._preloadCache.inputSettings = {}), t3.inputSettings && t3.inputSettings.audio && (this._preloadCache.inputSettings.audio = t3.inputSettings.audio), t3.inputSettings && t3.inputSettings.video && (this._preloadCache.inputSettings.video = t3.inputSettings.video), this.sendMessageToCallMachine({ action: "join-meeting", properties: Xa(this.properties), preloadCache: Xa(this._preloadCache) }), new Promise(function(t4, r2) {
      e2._joinedCallback = function(i2, o3) {
        if (e2._callState !== Tr) {
          if (e2._updateCallState(Er), i2) for (var a3 in i2) e2._callObjectMode && (ha(i2[a3]), pa(i2[a3]), ga(i2[a3], e2._participants[a3])), e2._participants[a3] = Na({}, i2[a3]), e2.toggleParticipantAudioBasedOnNativeAudioFocus();
    ...
    return rs(this._testCallInProgress, "leave()"), new Promise(function(t3) {
      if (e2._callState === Mr || e2._callState === Tr) t3();
        ...
        t3();
      } else e2._resolveLeave = t3, e2.sendMessageToCallMachine({ action: "leave-meeting" });
    });
  }), function() {
    ...
    if (ns(this._dailyMainExecuted, "startScreenShare()"), t3.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", t3.screenVideoSendSettings), t3.mediaStream && (this._preloadCache.screenMediaStream = t3.mediaStream, t3.mediaStream = fo), "undefined" != typeof DailyNativeUtils && void 0 !== DailyNativeUtils.isIOS && DailyNativeUtils.isIOS) {
      var n2 = this.nativeUtils();
      if (yield n2.isScreenBeingCaptured()) return void this.emit(oo, { action: oo, type: "screen-share-error", errorMsg: "Could not start the screen sharing. The screen is already been captured!" });
    ...
    } else this.sendMessageToCallMachine({ action: lo, captureOptions: t3 });
  }), function() {
    return O2.apply(this, arguments);
    ...
    if (e2) {
      ...
      if (!_s(e2.length, 1, 3)) throw new Error("encodings must be an Array with between 1 to ".concat(3, " layers"));
      for (var r2 = 0; r2 < e2.length; r2++) {
        var i2 = e2[r2];
        for (var o3 in this._validateEncodingLayerHasValidProperties(i2), i2) {
          if (!qa.includes(o3)) throw new Error("Invalid key ".concat(o3, ", valid keys are:") + Object.values(qa));
          if ("number" != typeof i2[o3]) throw new Error("".concat(o3, " must be a number"));
          if (t3) {
            var a3 = t3[o3], s2 = a3.min, c2 = a3.max;
            if (!_s(i2[o3], s2, c2)) throw new Error("".concat(o3, " value not in range. valid range: ").concat(s2, " to ").concat(c2));
          }
        }
    ...
    try {
      !function(e3) {
        ...
        for (var t4 in e3) if (!Ya.includes(t4)) throw new Error("Invalid key ".concat(t4, ", valid keys are: ").concat(Ya));
    ...
    return Za(this._callState, "sendDTMF()"), function(e3) {
      ...
      if (!t4 || !n2) throw new Error("sessionId and tones are mandatory parameter");
      if ("string" != typeof t4 || "string" != typeof n2) throw new Error("sessionId and tones should be of string type");
      if (n2.length > 20) throw new Error("tones string must be upto 20 characters");
      var r2 = /[^0-9A-D*#]/g, i2 = n2.match(r2);
      if (i2 && i2[0]) throw new Error("".concat(i2[0], " is not valid DTMF tone"));
    ...
    }(this._dailyMainExecuted, "testCallQuality()"), t3.videoTrack && !this._validateVideoTrackForNetworkTests(t3.videoTrack)) throw new Error("Video track error");
    var r2 = this._testCallAlreadyInProgress, i2 = function(e2) {
      r2 || (n2._testCallInProgress = e2);
    };
    i2(true);
    var o3 = t3.videoTrack, a3 = e(t3, Aa);
    if (this._preloadCache.videoTrackForConnectionQualityTest = o3, this.needsLoad()) try {
    ...
    var t3;
    if (!((null === (t3 = Object.keys(e2)) || void 0 === t3 ? void 0 : t3.length) > 0)) throw new Error("Empty encoding is not allowed. At least one of these valid keys should be specified:" + Object.values(qa));
    ...
    if ("string" == typeof t3) {
      ...
      if (!t3.maxQuality && !t3.encodings && void 0 === t3.allowAdaptiveLayers) throw new Error("Video send settings must contain at least maxQuality, allowAdaptiveLayers or encodings attribute");
    ...
    if (Za(this._callState, "sendAppMessage()"), JSON.stringify(e2).length > 4096) throw new Error("Message data too large. Max size is 4096");
    ...
    if (as(), "number" != typeof e2 && true !== e2 && false !== e2) throw new Error("argument to setShouldPlayNewParticipantSound should be true, false, or a number, but is ".concat(e2));
    ...
    for (var t3 in e2) {
      if (!Ha[t3]) throw new Error("unrecognized property '".concat(t3, "'"));
      if (Ha[t3].validate && !Ha[t3].validate(e2[t3], this)) throw new Error("property '".concat(t3, "': ").concat(Ha[t3].help));
    }
    ...
    switch (t3.action) {
      ...
      case io:
        if (!N(this._inputSettings, t3.inputSettings)) {
          ...
          if (this._inputSettings = t3.inputSettings, this._preloadCache.inputSettings = {}, !N(f3, this._getInputSettings())) try {
    ...
    var n2 = "record";
    if (e2 && !t3.local && false === t3[n2] && e2[n2] !== t3[n2]) try {
    ...
    var n2 = "record";
    if (e2 && !t3.local && true === t3[n2] && e2[n2] !== t3[n2]) try {
      this.emit(Ai, { action: Ai });
    } catch (e3) {
      console.log("could not emit", e3);
    }
  } }, { key: "maybeEventTrackStopped", value: function(e2, t3, n2, r2) {
    if (e2 && ("ended" === e2.readyState || !t3 || e2.id !== t3.id)) try {
    ...
    if (t3 && (!e2 || "ended" === e2.readyState || t3.id !== e2.id)) try {
    ...
    if (e2) for (var n2 in e2.tracks) this.maybeEventTrackStopped(e2.tracks[n2].track, t3 && t3.tracks[n2] ? t3.tracks[n2].track : null, t3, n2);
  } }, { key: "maybeParticipantTracksStarted", value: function(e2, t3) {
    if (t3) for (var n2 in t3.tracks) this.maybeEventTrackStarted(e2 && e2.tracks[n2] ? e2.tracks[n2].track : null, t3.tracks[n2].track, t3, n2);
    ...
    var t3 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    if (as(), !e2 || !e2.contentWindow || "string" != typeof e2.src) throw new Error("DailyIframe::Wrap needs an iframe-like first argument");
...
function us(e2) {
  return "object" === i(e2) && (!!(e2.video && "object" === i(e2.video) || e2.audio && "object" === i(e2.audio)) && (!(e2.video && !function(e3) {
    ...
    if (e3.config) {
      if ("object" !== i(e3.config)) return false;
      if (!function(e4, t4) {
...
function gs(e2) {
  if (e2 && "object" !== i(e2) || Array.isArray(e2)) return console.error("customTrayButtons should be an Object of the type ".concat(JSON.stringify(Wa), ".")), false;
  if (e2) for (var t2 = 0, n2 = Object.entries(e2); t2 < n2.length; t2++) for (var r2 = g(n2[t2], 1)[0], o2 = 0, a2 = Object.entries(e2[r2]); o2 < a2.length; o2++) {
    ...
    if (i(l2) !== u2) return console.error("customTrayButton ".concat(c2, " should be a ").concat(u2, ".")), false;
  }
  return true;
}
function ms(e2) {
  if (!e2 || e2 && "object" !== i(e2) || Array.isArray(e2)) return console.error(fs()), false;
  for (var t2 = function(e3) {
    ...
    var a2 = g(o2[r2], 1)[0];
    if (!("label" in e2[a2])) return n2(a2, "label is required"), false;
    if (!("location" in e2[a2])) return n2(a2, "location is required"), false;
    if (!("src" in e2[a2]) && !("srcdoc" in e2[a2])) return n2(a2, "src or srcdoc is required"), false;
    for (var s2 = 0, c2 = Object.entries(e2[a2]); s2 < c2.length; s2++) {
      ...
      switch (u2) {
        ...
        case "referrerPolicy":
        case "sandbox":
          if ("string" != typeof d2) return n2(a2, t2(u2)), false;
          break;
        case "iconURL":
          if (!Z(d2)) return n2(a2, "".concat(u2, " should be a url")), false;
          break;
        case "src":
          if ("srcdoc" in e2[a2]) return n2(a2, "cannot have both src and srcdoc"), false;
          if (!Z(d2)) return n2(a2, 'src "'.concat(d2, '" is not a valid URL')), false;
          break;
        case "srcdoc":
          if ("src" in e2[a2]) return n2(a2, "cannot have both src and srcdoc"), false;
          if ("string" != typeof d2) return n2(a2, t2(u2)), false;
          break;
        case "location":
          if (!["main", "sidebar"].includes(d2)) return n2(a2, t2(u2)), false;
          break;
        case "controlledBy":
        ...
        case "shared":
          if ((!Array.isArray(d2) || d2.some(function(e3) {
            return "string" != typeof e3;
          })) && "owners" !== d2 && "boolean" != typeof d2) return n2(a2, t2(u2)), false;
          break;
        default:
          if (!za.id[u2]) return console.error("customIntegration does not support key ".concat(u2)), false;
      }
    }
  }
  return true;
...
function vs(e2, t2) {
  ...
  switch (i(t2)) {
    case "string":
      return i(e2) === t2;
    case "object":
      if ("object" !== i(e2)) return false;
      for (var n2 in e2) if (!vs(e2[n2], t2[n2])) return false;
      return true;
    default:
      return false;
  }
...
function ys(e2) {
  if ("object" !== i(e2)) throw new Error('RemoteMediaPlayerSettings: must be "object" type');
...
@daily-co/daily-js/dist/daily-esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SJLCFBXJ.js.map
